...
public class FileSelectionActivity extends Activity {
    ...
    private File mainPath = new File(Environment.getExternalStorageDirectory().getAbsolutePath());
 ...
 ok=(Button) findViewById(R.id.ok);
    ...
    public void onUploadClick(){
        ...
        finish();
        Toast.makeText(this,"Files: "+resultFileList.toString(),Toast.LENGTH_SHORT).show();
    }
